...
/** 
* Returns a default conversion from a given type 
*/
Converter.prototype.toDefault = function() {
  if(!this.origin)
    throw new Error('.to must be called after .from');
  var conversion = new Object;
  conversion.val = this.to(this.origin.unit.to_default);
  conversion.destination  = this.destination;
  return conversion
}
